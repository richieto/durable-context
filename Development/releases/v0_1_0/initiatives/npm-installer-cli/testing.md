...
| --- | --- | --- | --- |
| CLI smoke | Empty target install, custom release, `--no-documentation`, repeated dry run | `tests/cli-smoke.test.js` | Passing |
...
- `npm test` passes.
- `npm pack --dry-run` includes `AGENTS.md`, `.agents/`, `Development/`,
  optional `Documentation/`, and `bin/`.
