...
- Reference root: `REFERENCE_ROOT/<Area>/`
...
| --- | --- | --- |
| TBD | `REFERENCE_ROOT/<Area>/features/<feature>.md` | TBD |
...
List area-specific terms or link to `REFERENCE_ROOT/_authoring/terminology.md`.
